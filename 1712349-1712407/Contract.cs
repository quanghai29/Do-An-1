...
namespace _1712349_1712407
{
    ...
    public class FullnameNormalize:StringArgs
    {
    ...
    {
        public StringArgs Args { get; set; }//Tham so nhan vao
        public abstract string Operation(string Origin);//Hanh dong xu li
        public abstract string Name { get; }//Ten hanh dong
        public abstract string Description { get; }//Phan mo ta hanh dong
